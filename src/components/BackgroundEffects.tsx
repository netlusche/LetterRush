...
export const BackgroundEffects: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const orbs: Orb[] = [];
    // Orb palette depends on the active theme: the LetterRush default uses the
    // logo accent colors, while "Neon Party" keeps the original neon palette.
    const colors = theme === 'neon_party'
      ? [
      ...
      : [
          'rgba(246, 146, 30, 0.08)',
          'rgba(59, 163, 219, 0.08)',
          'rgba(70, 192, 138, 0.06)',
          'rgba(246, 183, 60, 0.05)'
        ];
    const initOrbs = () => {
      orbs.length = 0;
